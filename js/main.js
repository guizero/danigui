(function () {
  ...
  function done_func(response) {
    ...
    message.text("Oba! Nos vemos em Agosto!");
    setTimeout(function () {
      message.fadeOut();
    }, 55000);
    form.find('input:not([type="submit"]), textarea').val("");
    $("#rsvp-btn").attr("disabled", false);
    $("#rsvp-btn").val("CONFIRMAR PRESENÇA...")
  }
  function fail_func(data) {
    ...
    $("#rsvp-btn").attr("disabled", false);
    $("#rsvp-btn").val("ENVIANDO...")
    $("#rsvp-btn").val("CONFIRMAR PRESENÇA...")
  }
  form.submit(function (e) {
    e.preventDefault();
    $("#rsvp-btn").attr("disabled", true);
    $("#rsvp-btn").val("ENVIANDO...")
    jQuery($(this))
      .serializeArray()
      .map(function (item) {
...
(function () {
  const second = 1000,
    ...
    hour = minute * 60,
    day = hour * 24;
  let birthday = "Aug 10, 2024 12:00:00",
